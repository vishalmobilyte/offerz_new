        ...
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 analytic_bg_whi"> 
            ...
            <div class="col-md-6 col-sm-6 cell_pad">
              <div class="dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
					...
					<li><a href="javascript:void(0)">Most Influencers</a></li>
					<li><a href="javascript:void(0)">Most Connections</a></li>
					<li><a href="javascript:void(0)">Most Offerz</a></li>
					<li><a href="javascript:void(0)">Most Impressions</a></li>
					<li><a href="javascript:void(0)">Most % Complete</a></li>
					<li role="separator" class="divider"></li>
					<li><a href="javascript:void(0)">Least Influencers</a></li>
					<li><a href="javascript:void(0)">Least Connections</a></li>					
					<li><a href="javascript:void(0)">Least Offerz</a></li>
					<li><a href="javascript:void(0)">Least Impressions</a></li>
					<li><a href="javascript:void(0)">Least % Complete</a></li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div class="row border_t_performanec followers">
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
              <img class="performer_pic" style="border-radius: 50%;" src="<?php if($dis['twt_pic']){
            ...
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
              <h4 > <?php echo $dis['twt_followers']; ?> </h4>
